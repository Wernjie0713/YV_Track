...
<div class="card shadow-sm">
	<div class="card-header">
        ...
        <form action="<?php echo URLROOT; ?>/resumes/update/<?php echo $data['students']->stu_id; ?>" method="POST">
			...
			<tr>
				...
				<td style="width:70%;vertical-align:top">
					...
					<?php if(isset($data['combines2'])): ?>
						...
						<?php endforeach; ?>
					<?php endif; ?>
					<p><b>You can add your participated activity here:</b></p>
					<input type="hidden" name="stu_id" value="<?php echo $data['students']->stu_id; ?>">
					<div class="mb-10">
						<label for="exampleFormControlInput1" class="required form-label">Activity Name:</label>
						<input type="text" name="add_actname" class="form-control form-control-solid" required />
					</div>
					<div class="mb-10">
						<label for="exampleFormControlInput1" class="required form-label">Activity Start Date:</label>
						<input type="date" name="add_actstartdate" class="form-control form-control-solid" required />
					</div>
					<div class="mb-10">
						<label for="exampleFormControlInput1" class="required form-label">Activity End Date:</label>
						<input type="date" name="add_actenddate" class="form-control form-control-solid" required />
					</div>
					<div class="mb-10">
						<label for="exampleFormControlInput1" class="required form-label">Describe your role or responsibility:</label>
						<input type="text" name="add_actans" class="form-control form-control-solid" required />
					</div>
				</td>
			</tr>
