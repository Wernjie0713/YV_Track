...
<div class="card shadow-sm ">
	...
	<a href="<?php echo URLROOT . "/resumes/update/" . $data['students']->stu_id ?>" class="btn btn-secondary edit-button" style="position: absolute; bottom: 10px; right: 10px; width: 70px; height: 50px; border-radius: 50%;">
